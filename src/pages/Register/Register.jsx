...
const Register = () => {
  ...
  return (
    <div className="mx-auto my-auto w-2/3 h-[470px] sm:w-auto lg:w-[1000px] lg:mx-auto sm:mx-4 flex rounded-3xl drop-shadow-2xl overflow-hidden">
      <div
        style={{ backgroundImage: `url(${OrangeVan})` }}
        className="relative bg-cover bg-center w-0 sm:w-1/2 md:w-3/5 "
      >
        {/* <div className="flex flex-col w-24 items-center justify-center text-sm font-semibold absolute top-1/4 right-0">
          <NavLink
            to="."
            end
            className={({ isActive }) =>
